...
\begin{itemize}
  ...
  % TODO: something odd here; the original draft referred to "Benaloh 1985",
  % though the URL it had points at a paper by Cohen and Fischer in 1985.
  % But the Cohen and Fischer paper doesn't seem to propose homomorphic
  % encryption as an alternative to mix nets on my brief reading. A more
  % careful reading, or a search for a Benaloh 1985 paper that proposes
  % homomorphic encryption, seems worthwhile before shipping this report.
