...
\item \emph{election officials} specifying (via RFIs or RFPs) or
  ...
  % do we need to include (via RFIs or RFPs)?
...
\item \emph{standards bodies} interested in standardizing what
  ...
  % is "rigorous certification" different from "certification"? (sorry, I really don't know!)
...
% I am looking forward to seeing the Galois position and how it might be different. Dying for a breakthrough here.... S. 
...
\item \textbf{Privacy violations. }While E2E-V systems can mitigate
  ...
  violated.
  % do we need to say "voter or vote" - maybe choose one. and why mix the feature of identifying errors with privacy. "When something goes wrong" is incredibly general. Need to be more specific here about what that means.
...
\item \textbf{The impact of bugs.} It is vastly more likely that a poorly-implemented E2E-V system 
  ...
  % geez, isn't there another word for bugs?
\item \textbf{Security mandates quality.} A low-quality implementation
  ...
  % how do we judge a low- vs. high-quality implementation? Is that discussed somewhere in a technical chapter?
\end{enumerate}
...
% I don't know why, but I don't like the way this is phrased. I don't even really understand what it says except that it is like fear mongering and then it tells me to do something I can't do. Why do I feel like it will piss people off? Maybe we could say it differently - for example: In light of the summation of these issues which must be contended with in the development of an E2E-V system, a responsible implementation will.... etc. 
\begin{center}
...
\begin{center}
  \textbf{\emph{Recommendation VI:} An appropriate group of dedicated
    ...
    % Perhaps... "A recognized group of qualified subject-matter specialists with credentials in [list - things like cyber-security, high-assurance cyrptographic methods etc...] should be identified and tasked to...."
