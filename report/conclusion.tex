...
detail in a separate document~\cite{E2EVIVRequirements}, is useful to
several audiences:
\begin{itemize}
...
\textbf{\emph{Recommendation: HIGH ASSURANCE.} \ End-to-end verifiable
...
There are several underlying, long-lived, positivist memes about
Internet voting: that it will increase voter participation, it will
help with voter decision-making and engagement, it will provide equal
opportunity for voters with disabilities, and it will decrease
election costs.

There are similar memes about E2E-V election systems: that they will
prevent corrupt election officials and governments from manipulating
election outcomes and they will truly capture the voice of the people
and increase their confidence and trust in their governments.

These memes are hypotheses.  The only way to check the veracity of a
hypothesis is to conduct experiments under peer-review.  If these
conjectures are bona fide, then impacting the world for good through
trustworthy democracy is certainly a worthwhile goal. Though
considerable challenges remain, we should strive to achieve it.
