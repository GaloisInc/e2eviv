...
\item \emph{election officials} specifying, evaluating, or purchasing
  ...
  % do we need to include (via RFIs or RFPs)? -SDS
  % removed -JRK
...
\item \emph{standards bodies} interested in standardizing what
  ...
  % is "rigorous certification" different from "certification"?
  % (sorry, I really don't know!) -SDS
  % Yes, existing certification is pretty much the opposite of
  % rigorous. If you compare the kind of certification suggested for
  % elections systems vs. the kind of certification mandated for
  % safety-critical systems, it is night and day. -JRK
...
% I am looking forward to seeing the Galois position and how it might
% be different. Dying for a breakthrough here.... -SDS
...
% maybe there is a different way to phrase this. Not sure about the
% word "alarming"... -SDS
% I'm sticking with alarming for the moment just because that is the
% phrasing that Josh has been running with. -JRK
...
% why? why even say this? -SDS
% That't the point of the implications below. Every one of those
% implications is directly caused by the claim that software
% independent systems need not have good systems engineering. -JRK
...
\item \textbf{Security mandates quality.} A low-quality implementation
  ...
  % how do we judge a low- vs. high-quality implementation? Is that
  % discussed somewhere in a technical chapter? -SDS
  % Yes, it is. -JRK
\end{enumerate}
...
% I hope this stat is confirmed! -SDS
% It was in a long discussion I had with Whitney this week. -JRK
...
\begin{center}
  \textbf{\emph{Recommendation MOVE-FORWARD:} A recognized dedicated
    ...
    % Perhaps... "A recognized group of qualified subject-matter
    % specialists with credentials in [list - things like
    % cyber-security, high-assurance cyrptographic methods etc...]
    % should be identified and tasked to...." -SDS
    % Done. -JRK
