...
definition---regardless of its implementation technology---run on
...
corrupted; second, a voter's computing environment might be corrupted
in a way such that the voter's interactions with the software are
compromised.
