...
purpose~\cite{OldSPLBad}.  Such software often ends up being an
impenetrable ball of mud that is extremely difficult to maintain.
...
software system~\cite{QualityA,QualityB,QualityC}.  
...
140-2~\cite{ISO9000,CMMI,IEC-62304,FIPS-140-2}.
...
reside upon objective machine-interpretable evidence.

\subsection{Interpreting Evidence for the Non-expert}

\todokiniry{To be written.}
