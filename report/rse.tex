...
For example, the domain model for E2E-VIV systems
\cite{E2EVIVDomainModel} includes, among many others, the concepts
...
type of contest, with a certain set of characteristics. One
relationship among elections, choices, and contests is that an
...
themselves are available in a separate
document~\cite{E2EVIVRequirements}.
...
process. The BON representation of the E2E-VIV
requirements~\cite{E2EVIVRequirements} consists almost entirely of
simple English sentences; it is therefore far more accessible to a
wide audience than an equivalent set of UML diagrams would be.
