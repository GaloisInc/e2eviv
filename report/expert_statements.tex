...
In this paper we demonstrate that end-to-end verifiable (E2EV) voting
...
\subsection{The power of E2EV systems}
...
These powerful E2EV security properties are not shared by any
...
In an E2EVIV system voters compose and input their vote choices on a
...
\item Denial of service: The easiest malware attack is to simply
  ...
  tried to vote online but that malware ate her ballot. Perhaps she
  ...
  erased itself, leaving no trace whatsoever.
  ...
  E2EVIV system does nothing to help with such an estimate because the
  ballots are discarded by the malware before they ever enter the
  E2EVIV system.
...
\item Privacy violation: Malware on a voter's computer or mobile
  ...
  privacy violation, but with automated spying on many online votes.
...
One especially dangerous form of network attack is the distributed
