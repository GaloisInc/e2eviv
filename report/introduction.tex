...
\section{Overview}\todo{We probably don't really want to call this
  ``overview'', but if we do want to have subsections, we need an
  enclosing section of some kind. It used to be ``The E2E-VIV Project,
  but that's now below.}
...
management, wrote and edited the final report,\todo{Does this need to
  be qualified?} and facilitated the communication and decision-making
of the team.\footnote{Galois is a leader in the process of computing
  ...
  fundamental to the project’s achievements.\todo{Should we leave this
  footnote in?'}}
...
involved. \todo{This is unsatisfying and we need to figure out what to
  really say here.}
...
At the time of this writing, no definitive assessments have been
made. \todo{Is that really the case by the time we publish the report,
  or will we be able to say something here?}
...
\item \emph{Voters are not interested in learning about verifiability
  ...
  nevertheless, always be achieved.  \todokiniry{Make sure
    requirements for verifiability and our recommendations are
    strengthened given the UX study. -JRK}
