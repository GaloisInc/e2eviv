...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% this is just a comment. perhaps it has been done and I don't know about it, but we need to introduce the
% long name of the project and its abbreviated name "End-to-End Verifiable Internet Voting: Specification and Feasibility 
% Assessement Study (E2E VIV Project) - to just make that this section header/title. 
...
Within this climate, 
% comment from susan: we may need to define again what exact climate, as we have lost the original flow
...
% I broke up the following paragraphs a bit. They seemed like very large blocks of text that could be naturally broken down a bit more
...
% I would suggest moving the final para of this section here and then changing "The Galois engineers brought significant expertise to the project and set about developing" to "The Galois engineers developed"
...
% the demonstrators "were", "are" or "will be"?
\begin{itemize}
...
% is it possible to reduce the use of the word "expert"? Can we say participants, team members, contributors in some of these cases? In our roadshow, there was feedback that overuse of the word was taken poorly by election officials - who are - afterall - the true experts in elections. I don't want us to repeat this and get the same shut-off-valve reaction.  
\begin{enumerate}
