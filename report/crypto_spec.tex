\chapter{Crypto Specification\ifdraft{ (Aggelos et al.) (15\%)}{}}
\label{chapter:crypto_spec}


\section{Ideal Functionality of an E2E System---$\fete$}
\todokiniry{Dan parked this here, because it doesn't belong in the
  ``requirements'' chapter, but it may not really belong here
  either. Still, it or some variant of it probably does. Do with it
  what you will...}
