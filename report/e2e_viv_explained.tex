...
Before the election, a random seed\footnote{It is very difficult to
  ...
  seeds is very important in secure computing systems.}\todo{This
  explanation may need to be better/perhaps integrated into the text}
...
sharing scheme.\footnote{In a \emph{secret sharing scheme}, a computer
  ...
  than the required number of parts reveals nothing.}\todo{Again,
  integrate this into the text?} Using this seed, the system generates
...
Remotegrity~\cite{zagorski2013} is a code voting system\footnote{A
  ...
  selected from the code the voter entered.}\todo{Yet again... Maybe
  we need a section for ``definitions'' before we discuss the voting
  systems?} that was used for absentee voting alongside Scantegrity
