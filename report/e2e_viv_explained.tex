\chapter{E2E VIV Explained\ifdraft{ (Philip/Daniel/Adam) (75\%)}{}}
...
with each choice on the ballot is a vote code---the encryption of the
vote, which is entered in the voting machine by the voter, and a
receipt code which the voter does not enter, but which is posted
online next to the vote code.
